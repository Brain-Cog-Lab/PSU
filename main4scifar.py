...
parser.add_argument('--model', default='SeCifarNet', type=str, metavar='MODEL', help='Name of model to train (default: "countception"')
...
parser.add_argument('--weight-decay', type=float, default=0.01, help='weight decay (default: 0.01 for adamw)')
...
parser.add_argument('--output', default='/data/ly/PSU', type=str, metavar='PATH', help='path to output folder (default: none, current dir)')
...
# Spike parameters
parser.add_argument('-T', '--step', type=int, default=32, help='Simulation time step (default: 10)')
...
def main():
    ...
    if args.node_type in ['SPSN', 'PSU', 'IPSU', 'RPSU', 'PPSU']:

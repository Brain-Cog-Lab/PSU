...
parser.add_argument('--dataset', default='cifar10', type=str)  # sew_resnet19
parser.add_argument('--model', default='cifar_convnet', type=str, metavar='MODEL', help='Name of model to train (default: "countception"')
...
parser.add_argument('-b', '--batch-size', type=int, default=64, metavar='N', help='inputs batch size for training (default: 128)')
...
parser.add_argument('--weight-decay', type=float, default=1e-2, help='weight decay (default: 0.01 for adamw)')
...
parser.add_argument('--output', default='/home/liyang/code/PSU/log', type=str, metavar='PATH', help='path to output folder (default: none, current dir)')
...
# Spike parameters
parser.add_argument('-T', '--step', type=int, default=4, help='Simulation time step (default: 10)')

...
parser.add_argument('--dataset', default='dvsc10', type=str) # sew_resnet19
parser.add_argument('--model', default='VGG_SNN', type=str, metavar='MODEL', help='Name of model to train (default: "countception"')
...
parser.add_argument('-nc', '--num-classes', type=int, default=10, metavar='N', help='number of label classes (default: 1000)')
...
parser.add_argument('-b', '--batch-size', type=int, default=128, metavar='N', help='inputs batch size for training (default: 128)')
...
parser.add_argument('--weight-decay', type=float, default=5e-4, help='weight decay (default: 0.01 for adamw)')
...
# Spike parameters
parser.add_argument('-T', '--step', type=int, default=10, help='Simulation time step (default: 10)')
...
# neuron type
parser.add_argument('-n', '--node-type', type=str, default='LIFNode', help='Node type in network (default: PLIF)')
parser.add_argument('--act-fun', type=str, default='QGateGrad', help='Surogate Function in node. Only for Surrogate nodes (default: AtanGrad)')
...
# parser.add_argument('-tet', '--tet-loss', default=True, type=bool)
...
def train_epoch(
    ...
    return OrderedDict([('loss', losses_m.avg), ('time', time.time()-start)])
...
def validate(epoch, model, loader, loss_fn, args, amp_autocast=suppress,
    ...
    metrics = OrderedDict([('loss', losses_m.avg), ('top1', top1_m.avg), ('time', time.time()-start)])
